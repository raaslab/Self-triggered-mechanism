function multirobot_self_movtar_disEKF_cond(~,~)


global N omega_max tarx_hat tary_hat i_store iself_count self_tolerance gVimid id ...
...
idb=[N;id(:,1);1];
        ...
        for i=1:N
                       ...
                       errp(i)=gVimid(i)-robot_itheta_last(i); 
                       abserrp(i)=abs(gVimid(i)-robot_itheta_last(i));
